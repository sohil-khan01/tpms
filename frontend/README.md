...
docker pull eightbitsystem3/talent-pool-frontend:latest

# 2. Run the container
docker run -d -p 2002:80 eightbitsystem3/talent-pool-frontend
```

Then open browser: **http://localhost:2002**
